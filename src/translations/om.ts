...
export const om = {
  ...
  applicationForm: {
    ...
    description: "Garee namoota 18-22 of kennan ijaaruuf nu gargaaraa",
    sections: {
      personalInfo: "Odeeffannoo Dhuunfaa",
      personalInfoDesc: "Waa'ee kee nutti himii",
      interest: "Fedhii Kee Ansaar Dargaggoota Keessatti",
      interestDesc: "Kaka'umsa keetii fi dandeettii kee hubachuuf nu gargaari",
      availability: "Yeroo Kee",
      availabilityDesc: "Yeroo kennuu dandeessu hubachuuf nu gargaari",
      finalDetails: "Bal'ina Dhumaa",
      finalDetailsDesc: "Iyyannoo kee xumuri"
    },
    fields: {
      fullName: "Maqaa Guutuu",
      age: "Umurii",
      gender: "Saala",
      countryCity: "Biyya fi Magaalaa",
      phoneNumber: "Lakkoofsa Bilbilaa (WhatsApp)",
      telegramUsername: "Maqaa Fayyadamaa Telegram",
      telegramUsernameDesc: "Filannoo - qunnamtii garee",
      emailAddress: "Teessoo Email",
      whyJoin: "Maaliif Ansaar Dargaggoota makamuu barbaadda?",
      whyJoinDesc: "Kaka'umsa keetii fi waan hojii Islaamii siif hawwatu qoodi",
      interestAreas: "Garee(wwan) kam gargaaruu barbaadda?",
      interestAreasDesc: "Bakka gumaacha gochuu barbaaddu tokko ykn caalu filadhu",
      skillsExperience: "Dandeettii ykn muuxannoo maalii qabda?",
      skillsExperienceDesc: "Dandeettii, meeshaalee beektu, ykn muuxannoo duraa tarreessi",
      hoursPerWeek: "Torbanitti sa'aatii meeqa kennuu dandeessa?",
      workingStyle: "Akkaataa Hojii Filannoo",
      weeklyMeetings: "Walgahii torbanaa virtual irratti hirmaachuu dandeessaa?",
      weeklyMeetingsDesc: "Walgahii qindoomina garee torbanuma qabna",
      spiritualMotivation: "Hojii Islaamii gochuuf maaltu si kakaasa?",
      spiritualMotivationDesc: "Kaka'umsa hafuura qulqulluu keetii fi waan tajaajila gochuu siif fedhisiisu qoodi",
      joinTelegramGroup: "Garee Telegram garee keenyatti dabalamuu barbaaddaa?",
      joinTelegramGroupDesc: "Bakki nu hojii guyyaa qindoomsinuu fi walqunnamnu kanaa dha",
      questionsNotes: "Gaaffii ykn yaadannoo dabalataa qabdaa?",
      questionsNotesDesc: "Gaaffii gaafachuu ykn waan biroo nu beeksisuu barbaaddu bilisaan qoodi"
    },
    buttons: {
    ...
    success: {
      ...
      message: "Ansaar Dargaggoota makamuu iyyannee guddaa!",
      description: "Gareen bulchiinsaa keenya iyyannoo kee ilaalanii dafanii si qunnamti. Waaqni niyyaa fi carraaqqii kee haa fudhatuutii.",
      quote: '"Namni fedhiidhaan waan gaarii godhu kam iyyuu - dhugumaan Waaqni galateeffataatii fi beeku dha." (Qur\'aan 2:158)'
    },
    validation: {
